...
<template>
    ...
    <v-dialog v-model="showConfirmation" max-width="500px">
        <v-card>
            ...
            <v-card-actions>
                <v-btn color="primary" class="px-4" variant="flat" rounded="pill" @click="confirmDelete">Yes, Delete</v-btn>
                <v-btn color="error" variant="flat" rounded="pill" class="px-4" @click="showConfirmation = false">Cancel</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
</template>
