        ...
        <perfect-scrollbar class="max-h-600">
            <div v-if="filteredEmails.length">
                <div
                    ...
                    :key="email.id"
                    :class="['email-items cursor-pointer', { 'selected-email bg-bglight': email === selectedEmail }]"
                        ...
                        <div class="d-flex align-center justify-space-between mt-3">
                            <div class="d-flex align-center ga-2">
                                ...
                                <button @click.stop="toggleIcon(email)">
                                    <icon v-if="email.starred" icon="solar:star-bold" height="15" class="text-warning" />
                                    <icon v-else icon="solar:star-line-duotone" height="15" />
                                </button>

                                <button @click.stop="toggleIconimportant(email)">
                                    <icon v-if="email.important" icon="solar:info-circle-bold" height="15" class="text-info" />
