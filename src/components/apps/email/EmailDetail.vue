    ...
    <div v-if="store.selectedEmail" class="email-detail">
        <div class="d-flex align-center ga-1 pb-6">
            <v-btn icon rounded="circle" size="small" variant="text" color="primary" @click.stop="toggleIcon(store.selectedEmail)">
                <icon v-if="store.selectedEmail.starred" icon="solar:star-bold" height="18" class="text-warning" />
            ...
            <v-btn icon rounded="circle" size="small" variant="text" color="primary" @click.stop="toggleIconimportant(store.selectedEmail)">
                <icon v-if="store.selectedEmail.important" icon="solar:info-circle-bold" height="18" class="text-info" />
        ...
        <div class="d-flex align-center justify-space-between mb-7">
            <div class="d-flex align-center ga-2">
                <v-avatar size="48"> <img :src="store.selectedEmail.thumbnail" alt="user" width="48" /></v-avatar>
                <div>
