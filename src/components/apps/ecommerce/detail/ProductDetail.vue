            ...
            <v-col lg="6" sm="12" class="pl-lg-5">
                <div>
                    <div class="d-flex align-center gap-2">
                        <v-chip color="success" variant="elevated" size="x-small" elevation="0" v-if="getProduct.isStock">
                            In Stock
                        </v-chip>
                ...
                <v-row class="mt-6">
                    ...
                    <v-col cols="12" md="auto" sm="3">
                        <v-btn block size="large" class="px-sm-8" rounded="pill" color="error" @click="store.AddToCart(getProduct)"
                            >Add To Cart</v-btn
                        >
                    </v-col>
                </v-row>
                <div class="mt-8">
                    ...
                    <RouterLink to="/" class="text-subtitle-1 text-decoration-none font-weight-medium text-primary"
