        ...
        <v-row>
            ...
            <v-col md="6" sm="12" class="pl-lg-5">
                ...
                <div class="text-medium-emphasis align-center d-flex mt-1 gap-2">
                    ...
                    ><span class="font-weight-semibold text-grey200 text-h5 ml-n1">{{ getProduct.rating?.toFixed(1) }}</span>
                ...
                <v-row class="mt-3">
                    ...
                    <v-col cols="12" sm="6" class="mt-sm-0 mt-n3">
                        <v-btn block size="x-large" rounded="pill" color="primary" @click="store.AddToCart(getProduct)">Add To Cart</v-btn>
                    </v-col>
                </v-row>
