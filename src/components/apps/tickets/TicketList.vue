        ...
        <v-card-item>
            ...
            <div class="">
                <div class="d-sm-flex justify-space-between align-center my-7">
                    <v-btn color="primary" class="rounded-pill" @click="showCreateTicketModal = true">Create Ticket</v-btn>
    ...
    <v-dialog v-model="showCreateTicketModal" max-width="500px">
        <v-card>
            ...
            <v-card-actions class="ga-3">
                <v-btn color="error" variant="flat" class="px-5" rounded="pill" @click="showCreateTicketModal = false">Cancel</v-btn>
                <v-btn color="primary" variant="flat" class="px-5" rounded="pill" @click="createTicket">Create</v-btn>
            </v-card-actions>
        </v-card>
    </v-dialog>
</template>
