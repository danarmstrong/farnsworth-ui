        ...
        <v-card-item>
            ...
            <v-row>
                <v-col cols="12" sm="7" class="pt-7">
                    <apexchart type="bar" class="profit-expense" height="300" :options="chartOptions" :series="chartOptions.series">
                    </apexchart>
                </v-col>
                <v-col cols="12" sm="5" class="mt-8 pb-6">
                    ...
                    <div class="d-flex align-center gap-4 mb-6 pb-3">
                        ...
                        <div>
                            <h5 class="text-h5 font-weight-semibold">$48,820.00 <span class="text-subtitle-2 text-success">23%</span></h5>
