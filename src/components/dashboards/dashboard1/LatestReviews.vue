        ...
        <v-card-text>
            <div class="d-sm-flex d-block justify-space-between d-block align-center mb-4">
                <div>
                    ...
                    <div class="text-subtitle-1 text-grey100 pb-1 font-weight-medium">Reviewd received across all channels</div>
                </div>
            ...
            <div class="border-table">
                <v-table class="mb-0">
                    <template v-slot:default>
                        <thead>
                            <tr>
                                <th class="pl-0"><v-checkbox color="primary" density="compact" hide-details></v-checkbox></th>
