            ...
            <v-dialog v-model="updateModalShow" max-width="500px">
                <v-card>
                    <v-card-text>
                        ...
                        <v-btn @click="updateEvent" rounded="pill" color="primary" class="mt-6"> Update Event </v-btn>

                        <v-btn @click="deleteEvent" rounded="pill" color="error" class="mt-6 ms-4"> Delete Event </v-btn>
                    </v-card-text>
                </v-card>
            </v-dialog>
        </div>
